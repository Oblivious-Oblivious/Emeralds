...
File.write("src/constants/version.cr", File.read("src/constants/version.cr").sub(/(VERSION\s*=\s*)"[^"]+"/, "\\1\"#{version}\""));
...
cmd("git", "add", "shard.yml", "src/constants/version.cr", "em.json", "README.md", "scripts/get.sh");
