...
module Emeralds::FileCreatorHelper
    @@name : String = "";
    def self.name=(other : String)
        @@name = other;
    end
    def self.name
        @@name;
    ...
    def self.create_source_directories
        Dir.mkdir "#{name}/src";
    ...
    def self.create_source_files
        puts "  #{ARROW} src";
        self.create_src_main;
        self.create_src_header;
        
        puts "    #{ARROW} #{name}";
        self.create_value_main;
        
        puts "      #{ARROW} headers";
        self.create_value_header;
    end

    # Cretes a dummy spec file using cSpec
    def self.create_spec_main
